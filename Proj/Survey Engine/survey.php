...
<body>
    <section class="container content-section">
        <h1 class="section-header" style="margin: 5px 5px">Edit Survey</h1>
            <?php
            if (isset($_GET['id'])) {
                $survey = new ViewSurvey();
                $survey->showSurvey($_GET['id']);      
                }
            ...
            if (isset($_GET['error'])) {
                if ($_GET['error'] == "emptyfield") {
                    echo '<p class="signup-error">Empty field! Edit failed!</p>';
                }   
            }
            ?>
    </section>
